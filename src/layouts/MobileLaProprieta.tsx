...
function Image() {
  return (
    <div className="aspect-[352/352] bg-white content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Image">
  ...
  return (
    <div className="content-stretch flex flex-col font-['Open_Sans:Regular',sans-serif] items-start leading-[0] not-italic relative shrink-0 text-[#333333] text-[0px] w-full" data-name="col">
      ...
      <div className="leading-[1.4] relative shrink-0 text-[18px] w-full">
        <p className="font-['Open_Sans:Regular',sans-serif] mb-0 not-italic">{`Dal salone, fulcro abitativo della casa, una moderna scala in acciaio e vetro ci porta verso un ampio soppalco con affaccio sul living, ideale come zona lettura o studio. Nel sottotetto si trova una stanza armadio, facilmente adattabile a camera aggiuntiva e un bagno con vasca, elegante e confortevole. Ripercorrendo la scala che dirige verso l'entrata troviamo al piano ammezzato, il vano tecnico e la lavanderia. `}</p>
        <p className="font-['Open_Sans:Regular',sans-serif] mb-0 not-italic">{`Al piano terra, lato sud con entrata indipendente, si trovano circa 90 mq di abitazione per gli ospiti composta da cucina, tavernetta, due bagni, uno studio e una sala hobby. `}</p>
        <p className="mb-0">&nbsp;</p>
...
function Copy1() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-full" data-name="copy">
      <SectionHeader />
      <Col />
    </div>
  );
...
function MaxW2() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-start relative shrink-0 w-full" data-name="max w">
      <Slide />
      <Copy1 />
    </div>
  );
  ...
  return (
    <div ref={ref} className={`bg-white relative shrink-0 w-full reveal-in-view ${isInView ? 'is-in-view' : ''}`} data-name="Contenuto con carousel">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col items-center px-[16px] py-[40px] relative w-full">
          <MaxW2 />
        </div>
      </div>
    </div>
...
function Image12() {
  return (
    <div className="aspect-[352/352] content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Image">
