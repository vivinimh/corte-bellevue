...
function Col() {
  ...
  return (
    <div className="content-stretch flex flex-col font-['Open_Sans:Regular',sans-serif] gap-[24px] items-start leading-[0] not-italic relative shrink-0 text-[#333333] w-full" data-name="col">
      <div className="relative shrink-0 w-full text-[18px]" data-name="left column">
...
function MaxW2() {
  return (
    <section className="content-stretch flex flex-col gap-[40px] items-center max-w-[1120px] relative shrink-0 w-full" data-name="max w">
      <Slide />
      <Copy1 />
    </section>
  );
...
function Copy3() {
  ...
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[24px] grow items-start min-h-px min-w-px relative shrink-0" data-name="copy">
      <p className="font-['EB_Garamond:Regular',sans-serif] font-normal leading-[1.18] relative shrink-0 text-[#ad3854] text-[24px] w-[352px]">{t.laProprieta.vignetoAcetaia.title}</p>
      <h3 className="block font-['Open_Sans:Regular',sans-serif] leading-[1.4] min-w-full not-italic relative shrink-0 text-[#333333] text-[18px] w-[min-content]">{t.laProprieta.vignetoAcetaia.description}</h3>
    </div>
  );
}
