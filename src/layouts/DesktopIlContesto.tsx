...
function MaxW2() {
  return (
    <div className="basis-0 content-stretch flex gap-[48px] grow h-full items-start justify-center max-w-[1120px] min-h-px min-w-px mx-auto relative shrink-0" data-name="max w">
      <Image1 />
      <Copy />
    </div>
  );
