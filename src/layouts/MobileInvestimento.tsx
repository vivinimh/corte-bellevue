  ...
  return (
    <article ref={ref} className={`bg-[#f6eee5] relative shrink-0 w-full reveal-in-view ${isInView ? 'is-in-view' : ''}`} data-name="contenuto foto isolata">
      <div className="flex flex-col items-center justify-center size-full" data-name="section wrapper">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center px-[16px] py-[40px] relative w-full" data-name="section container">
          <MaxW1 />
        </div>
      </div>
    </article>
...
function MaxW2() {
  return (
    <section className="content-stretch flex flex-col gap-[32px] items-start max-w-[1120px] relative shrink-0 w-full" data-name="max w">
      <Image1 />
      <Copy1 />
    </section>
  );
...
function MaxW3() {
  const t = useTranslation();
  return (
    <section className="content-stretch flex items-center justify-center max-w-[1120px] px-0 py-[40px] relative shrink-0 w-full" data-name="max w">
  ...
  return (
    <section ref={ref} className={`bg-[#f6eee5] relative shrink-0 w-full reveal-in-view ${isInView ? 'is-in-view' : ''}`} data-name="chiusura">
      <div className="flex flex-col items-center size-full" data-name="section wrapper">
        <div className="content-stretch flex flex-col items-center p-[40px] relative w-full" data-name="section container">
          <MaxW3 />
        </div>
      </div>
    </section>
