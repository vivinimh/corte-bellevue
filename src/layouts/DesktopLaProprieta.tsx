...
function Copy() {
  ...
  return (
    <section className="basis-0 content-stretch flex flex-col gap-[24px] grow items-start min-h-px min-w-px relative shrink-0" data-name="copy">
      <p className="font-['EB_Garamond:Regular',sans-serif] font-normal leading-[1.15] relative shrink-0 text-[#ad3854] text-[32px] w-full">{t.laProprieta.intro.title}</p>
      <div className="font-['Open_Sans:Regular',sans-serif] leading-[1.6] not-italic relative shrink-0 text-[#333333] text-[20px] w-full" data-name="description text content">
...
function MaxW1() {
  return (
    <section className="basis-0 content-stretch flex gap-[48px] grow items-start justify-center max-w-[1120px] min-h-px min-w-px px-0 py-[80px] relative self-stretch shrink-0 border-t border-b border-[#AD3854]" data-name="max w">
      <Image />
      <Copy />
    </section>
  );
...
function ContenutoFotoIsolata() {
  ...
  return (
    <article ref={ref} className={`relative shrink-0 w-full reveal-in-view ${isInView ? 'is-in-view' : ''}`} data-name="contenuto foto isolata">
      <div className="flex flex-row justify-center size-full" data-name="section wrapper">
        <div className="content-stretch flex items-start justify-center p-[80px] relative w-full" data-name="section container">
          <MaxW1 />
        </div>
      </div>
    </article>
...
function SectionHeader() {
  ...
  return (
    <header className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-full" data-name="Section header">
      <h2 className="block font-['EB_Garamond:Regular',sans-serif] font-normal leading-[1.1] relative shrink-0 text-[#ad3854] text-[48px] w-full">{t.laProprieta.bassoComodo.title}</h2>
    </header>
  );
}
...
function Col() {
  ...
  return (
    <div className="content-stretch flex flex-row font-['Open_Sans:Regular',sans-serif] gap-[80px] items-start leading-[0] not-italic relative shrink-0 text-[#333333] w-full" data-name="col">
      <div className="basis-0 grow min-h-px min-w-px relative shrink-0 text-[20px]" data-name="left column">
      ...
      <div className="basis-0 grow leading-[1.6] min-h-px min-w-px relative shrink-0 text-[20px]" data-name="right column">
        <p className="mb-0">{t.laProprieta.bassoComodo.description3}</p>
        <p className="mb-0">{t.laProprieta.bassoComodo.description4}</p>
        <p className="mb-0">&nbsp;</p>
...
function Copy1() {
  return (
    <section className="content-stretch flex flex-col gap-[48px] items-start relative shrink-0 w-full" data-name="copy">
      <SectionHeader />
      <Col />
    </section>
  );
...
function MaxW2() {
  return (
    <section className="content-stretch flex flex-col gap-[48px] items-center max-w-[1120px] relative shrink-0 w-full" data-name="max w">
      <Carousel />
      <Copy1 />
    </section>
  );
...
function Copy2() {
  ...
  return (
    <section className="basis-0 content-stretch flex flex-col gap-[24px] grow items-start min-h-px min-w-px relative shrink-0" data-name="copy">
      <p className="font-['EB_Garamond:Regular',sans-serif] font-normal leading-[1.15] relative shrink-0 text-[#ad3854] text-[32px] w-full">{t.laProprieta.altriLocali.title}</p>
      <div className="font-['Open_Sans:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#333333] text-[20px] w-full" data-name="description content">
        <h3 className="block leading-[1.6] mb-0">{t.laProprieta.altriLocali.description}</h3>
        <ul className="list-disc">
          <li className="mb-0 ms-[30px] whitespace-pre-wrap">
            <span className="leading-[1.6]">{t.laProprieta.altriLocali.casaPadronale}</span>
          </li>
          <li className="mb-0 ms-[30px]">
            <span className="leading-[1.6]">{t.laProprieta.altriLocali.annesso}</span>
          </li>
          <li className="ms-[30px]">
            <span className="leading-[1.6]">{t.laProprieta.altriLocali.fienileStalla}</span>
          </li>
        </ul>
      </div>
    </section>
...
function MaxW3() {
  return (
    <section className="basis-0 content-stretch flex gap-[48px] grow items-start justify-center max-w-[1120px] min-h-px min-w-px relative self-stretch shrink-0" data-name="max w">
      <Image12 />
      <Copy2 />
    </section>
  );
...
function Copy3() {
  ...
  return (
    <section className="basis-0 content-stretch flex flex-col gap-[24px] grow items-start min-h-px min-w-px relative shrink-0" data-name="copy">
      <p className="font-['EB_Garamond:Regular',sans-serif] font-normal leading-[1.15] relative shrink-0 text-[#ad3854] text-[32px] w-full">{t.laProprieta.vignetoAcetaia.title}</p>
      <h3 className="block font-['Open_Sans:Regular',sans-serif] leading-[1.6] not-italic relative shrink-0 text-[#333333] text-[20px] w-full">{t.laProprieta.vignetoAcetaia.description}</h3>
    </section>
  );
}
...
function Image13() {
  ...
  return (
    <figure className="aspect-[536/536] basis-0 content-stretch flex grow items-center min-h-px min-w-px relative shrink-0" data-name="Image">
      <div className="basis-0 grow h-full min-h-px min-w-px shrink-0 border-[1px] border-[#ad3854] p-[16px] relative" data-name="image gallery container">
        {images.map((image, index) => (
          <img 
            key={index}
            alt={altTexts[index]} 
