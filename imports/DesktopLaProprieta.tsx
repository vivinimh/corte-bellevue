...
function Copy() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[24px] grow items-start min-h-px min-w-px relative shrink-0" data-name="copy">
      <p className="font-['EB_Garamond:Regular',sans-serif] font-normal leading-[1.15] relative shrink-0 text-[#ad3854] text-[32px] w-full">Corte Belle Vue dispone di quattro edifici che possono essere utilizzati in futuro sia a scopo abitativo che commerciale, le strutture si affacciano su una corte comune e sono circondati da campagna a perdita d’occhio.</p>
      <div className="font-['Open_Sans:Regular',sans-serif] leading-[1.6] not-italic relative shrink-0 text-[#333333] text-[20px] w-full">
...
function MaxW1() {
  return (
    <div className="basis-0 content-stretch flex gap-[48px] grow items-start justify-center max-w-[1120px] min-h-px min-w-px px-0 py-[80px] relative self-stretch shrink-0 border-t border-b border-[#AD3854]" data-name="max w">
      <Image />
      <Copy />
    </div>
  );
  ...
  return (
    <article ref={ref} className={`relative shrink-0 w-full reveal-in-view ${isInView ? 'is-in-view' : ''}`} data-name="contenuto foto isolata">
      <div className="flex flex-row justify-center size-full">
        <div className="content-stretch flex items-start justify-center p-[80px] relative w-full">
          <MaxW1 />
        </div>
      </div>
    </article>
...
function Carousel() {
  return (
    <ImageCarousel
      ...
      initialIndex={1}
      variant="desktop"
      previousIconPath={svgPaths.p1dd9d600}
      nextIconPath={svgPaths.p270b3b00}
    />
  );
}
...
function SectionHeader() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-full" data-name="Section header">
      <h2 className="block font-['EB_Garamond:Regular',sans-serif] font-normal leading-[1.1] relative shrink-0 text-[#ad3854] text-[48px] w-full">Il basso comodo ristrutturato</h2>
    </div>
  );
}
...
function Col() {
  return (
    <div className="content-stretch flex flex-row font-['Open_Sans:Regular',sans-serif] gap-[80px] items-start leading-[0] not-italic relative shrink-0 text-[#333333] w-full" data-name="col">
      <div className="basis-0 grow min-h-px min-w-px relative shrink-0 text-[20px]">
        <p className="leading-[1.6] mb-0 not-italic whitespace-pre-wrap">
        ...
        <p className="leading-[1.6] not-italic">
      ...
      <div className="basis-0 grow leading-[1.6] min-h-px min-w-px relative shrink-0 text-[20px]">
...
function Copy1() {
  return (
    <div className="content-stretch flex flex-col gap-[48px] items-start relative shrink-0 w-full" data-name="copy">
      <SectionHeader />
      <Col />
    </div>
  );
...
function MaxW2() {
  return (
    <div className="content-stretch flex flex-col gap-[48px] items-center max-w-[1120px] relative shrink-0 w-full" data-name="max w">
      <Carousel />
      <Copy1 />
    </div>
  );
...
function Copy2() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[24px] grow items-start min-h-px min-w-px relative shrink-0" data-name="copy">
      <p className="font-['EB_Garamond:Regular',sans-serif] font-normal leading-[1.15] relative shrink-0 text-[#ad3854] text-[32px] w-full">Gli altri locali</p>
      <div className="font-['Open_Sans:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#333333] text-[20px] w-full">
        <h3 className="block leading-[1.6] mb-0">Al centro della proprietà, la casa padronale dal fascino autentico ed il suo fienile/stalla sulla destra, dominano la campagna emiliana</h3>
        <ul className="list-disc">
          <li className="mb-0 ms-[30px] whitespace-pre-wrap">
            <span className="leading-[1.6]">{`La casa padronale (edificio A - C) si sviluppa su due livelli oltre ad un sottotetto ad uso soffitta e una piccola porzione interrata ad uso cantina. Al pianterreno sono disposti locali quali androne passante: a sinistra il  soggiorno  e cucina; mentre a destra una stanza ad uso tv o sala hobby, l’accesso al vano scala e in fondo la  cantina. Al piano superiore  sono ubicate cinque camere oltre disimpegno, bagno e ripostiglio. Al secondo piano ampi locali ad uso soffitta con altezze comprese fra ml 1.00 e 2.55. La superficie totale è di  240 mq esclusa la soffitta. `}</span>
          </li>
          <li className="mb-0 ms-[30px]">
            <span className="leading-[1.6]">{`L'annesso (edificio A) ha una unica volumetria di 637 metri cubi e non è diviso in vani.`}</span>
          </li>
          <li className="ms-[30px]">
            <span className="leading-[1.6]">Il fienile/stalla (edificio D) è caratterizzato da un porticato d’epoca ad elle, unico nel suo genere; con ampi spazi che possono essere adibiti a scopo abitativo o commerciale ed ha una superficie totale di 1180 metri cubi, escluso il porticato.</span>
          </li>
        </ul>
      </div>
    </div>
...
function MaxW3() {
  return (
    <div className="basis-0 content-stretch flex gap-[48px] grow items-start justify-center max-w-[1120px] min-h-px min-w-px relative self-stretch shrink-0" data-name="max w">
      <Image12 />
      <Copy2 />
    </div>
  );
