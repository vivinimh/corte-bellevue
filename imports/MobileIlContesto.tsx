...
function MaxW1() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start px-0 py-[40px] relative shrink-0 w-full border-t border-b border-[#AD3854]" data-name="max w">
      <h2 className="block font-['EB_Garamond:Regular',sans-serif] font-normal leading-[1.15] relative shrink-0 text-[#714b55] text-[32px] w-full">Dove le eccellenze italiane sono di casa</h2>
      <Content />
    </div>
  );
}
