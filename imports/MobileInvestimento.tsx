  ...
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-start relative shrink-0 w-full" data-name="copy">
      <div className="font-['Open_Sans:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[#333333] text-[18px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        ...
        <h3 className="block">La sua versatilità è la chiave: la proprietà può trasformarsi in un Relais de Charme, in un agriturismo esclusivo, oppure in una residenza privata di prestigio per chi desidera vivere e investire nel cuore autentico dell'Emilia.</h3>
      </div>
    </div>
  );
}
...
function MaxW1() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start max-w-[1120px] relative shrink-0 w-full" data-name="max w">
      <Image />
      <Copy />
    </div>
  );
  ...
  return (
    <article ref={ref} className={`bg-[#f6eee5] relative shrink-0 w-full reveal-in-view ${isInView ? 'is-in-view' : ''}`} data-name="contenuto foto isolata">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center px-[16px] py-[40px] relative w-full">
          <MaxW1 />
        </div>
      </div>
    </article>
...
function Main() {
  return (
    <main className="content-stretch flex flex-col items-center p-0 relative shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] shrink-0 w-full" data-name="main" tabIndex="-1">
...
function TextBlock() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Text block">
      <Container />
    </div>
  );
}
