...
const imgImage1 = "https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=524&h=524&fit=crop";
...
function MaxW1() {
  return (
    <div className="basis-0 content-stretch flex gap-[80px] grow items-start max-w-[1120px] min-h-px min-w-px px-0 py-[80px] relative shrink-0" data-name="max w">
      <div aria-hidden="true" className="absolute border-[#ad3854] border-[1px_0px] border-solid inset-0 pointer-events-none" />
  ...
  return (
    <article className="bg-[#f6eee5] relative shrink-0 w-full" data-name="contenuto titolo isolato">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center p-[80px] relative w-full">
          <MaxW1 />
        </div>
      </div>
    </article>
    ...
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-full" data-name="Text content">
      ...
      <div className="size-full">
        <div className="content-stretch flex flex-col gap-[40px] items-start pl-[40px] pr-0 py-0 relative size-full">
          <h3 className="block font-['EB_Garamond:Regular',sans-serif] font-normal leading-[1.1] min-w-full relative shrink-0 text-[#ad3854] text-[48px] w-[min-content]">Le prospettive d'investimento</h3>
